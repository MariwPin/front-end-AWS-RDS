...
modalSearchButton.addEventListener('click', () => {
    ...
    axios.get(`http://3.86.66.89/php-intro-connection/getRecords.php?search=${encodeURIComponent(countryName)}`)
        .then(response => {
...
countryBtn.addEventListener('click', () => {
    clearRecords();
    axios.get('http://3.86.66.89/php-intro-connection/getRecords.php?table=country')
        .then(response => {
...
cityBtn.addEventListener('click', () => {
    clearRecords();
    axios.get('http://3.86.66.89/php-intro-connection/getRecords.php?table=city')
        .then(response => {
            console.log(response.data);  // Verifica la estructura de los datos en la consola
...
countryLanguageBtn.addEventListener('click', () => {
    clearRecords();
    axios.get('http://3.86.66.89/php-intro-connection/getRecords.php?table=countrylanguage')
        .then(response => {
            console.log(response.data);  // Verifica la estructura de los datos en la consola
